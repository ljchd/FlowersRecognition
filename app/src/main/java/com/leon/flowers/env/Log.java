...
public final class Log {
    ...
    private static final int DEFAULT_MIN_LOG_LEVEL = android.util.Log.DEBUG;
    ...
    /**
     * Creates a Log using the class name as the message prefix.
     *
    ...
    /**
     * Creates a Log using the specified message prefix.
     *
     * @param messagePrefix is prepended to the text of every message.
     */
    public Log(final String messagePrefix) {
        this(DEFAULT_TAG, messagePrefix);
    }

    /**
     * Creates a Log with a custom tag and a custom message prefix. If the message prefix is set to
     *
     * <pre>null</pre>
     *
     ...
     *     being used
     */
    public Log(final String tag, final String messagePrefix) {
        this.tag = tag;
        final String prefix = messagePrefix == null ? getCallerSimpleName() : messagePrefix;
        this.messagePrefix = (prefix.length() > 0) ? prefix + ": " : prefix;
    }

    /** Creates a Log using the caller's class name as the message prefix. */
    public Log() {
        this(DEFAULT_TAG, null);
    }

    /** Creates a Log using the caller's class name as the message prefix. */
    public Log(final int minLogLevel) {
        this(DEFAULT_TAG, null);
    ...
    public boolean isLoggable(final int logLevel) {
        return logLevel >= minLogLevel || android.util.Log.isLoggable(tag, logLevel);
    }
    ...
    public void v(final String format, final Object... args) {
        if (isLoggable(android.util.Log.VERBOSE)) {
            android.util.Log.v(tag, toMessage(format, args));
        }
    }
    ...
    public void v(final Throwable t, final String format, final Object... args) {
        if (isLoggable(android.util.Log.VERBOSE)) {
            android.util.Log.v(tag, toMessage(format, args), t);
        }
    }
    ...
    public void d(final String format, final Object... args) {
        if (isLoggable(android.util.Log.DEBUG)) {
            android.util.Log.d(tag, toMessage(format, args));
        }
    }
    ...
    public void d(final Throwable t, final String format, final Object... args) {
        if (isLoggable(android.util.Log.DEBUG)) {
            android.util.Log.d(tag, toMessage(format, args), t);
        }
    }
    ...
    public void i(final String format, final Object... args) {
        if (isLoggable(android.util.Log.INFO)) {
            android.util.Log.i(tag, toMessage(format, args));
        }
    }
    ...
    public void i(final Throwable t, final String format, final Object... args) {
        if (isLoggable(android.util.Log.INFO)) {
            android.util.Log.i(tag, toMessage(format, args), t);
        }
    }
    ...
    public void w(final String format, final Object... args) {
        if (isLoggable(android.util.Log.WARN)) {
            android.util.Log.w(tag, toMessage(format, args));
        }
    }
    ...
    public void w(final Throwable t, final String format, final Object... args) {
        if (isLoggable(android.util.Log.WARN)) {
            android.util.Log.w(tag, toMessage(format, args), t);
        }
    }
    ...
    public void e(final String format, final Object... args) {
        if (isLoggable(android.util.Log.ERROR)) {
            android.util.Log.e(tag, toMessage(format, args));
        }
    }
    ...
    public void e(final Throwable t, final String format, final Object... args) {
        if (isLoggable(android.util.Log.ERROR)) {
            android.util.Log.e(tag, toMessage(format, args), t);
        }
    }
}
